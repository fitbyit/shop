...
<div class="text-center p-10">
    <h1 class="font-bold text-4xl mb-4">Home Page</h1>
</div>
...
<section id="Projects"
    ...
    <form method="POST">
    <button type="submit" name="logout" class="w-full bg-red-600 text-white py-2 rounded-lg font-semibold hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-800 focus:ring-offset-2 transition-all duration-300 transform hover:scale-[1.02]">
        Logout
    </button>
</form>
